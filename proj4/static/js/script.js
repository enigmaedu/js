...
// Take a backup of the original button colors
var copyAllButtons=[];
for (let i=0; i < all_buttons.length; i++) {
    copyAllButtons.push(all_buttons[i]);
}
console.log('Copy of initial button state: ',copyAllButtons);

// main function that acts a switch
...
function buttonsColorReset() {
    for (let i=0; i<all_buttons.length; i++) {
        all_buttons[i].classList.remove(all_buttons[i].classList[1]);
        // all_buttons[i].classList.add(copyAllButtons[i]); //NOT Working
        // all_buttons[i].classList.add(copyAllButtons[i].classList[1]); //alternate - NOT Working
        // console.log(copyAllButtons[i].classList[1]);
        // all_buttons[i].classList.add('btn-warning'); // debug-works
        //  console.log(copyAllButtons[i]); debug
